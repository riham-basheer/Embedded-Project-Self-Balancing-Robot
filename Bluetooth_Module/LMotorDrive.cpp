...
LMotorDrive::LMotorDrive(int ena, int in1, int in2, int enb, int in3, int in4, double motorAConst, double motorBConst)
{
...
void LMotorDrive::move(int leftSpeed, int rightSpeed, int minAbsSpeed)
{
    if (rightSpeed < 0)
    {
...
void LMotorDrive::move(int speed, int minAbsSpeed)
{
    int direction = 1;
...
void LMotorDrive::move(int speed)
{
    if (speed == _currentSpeed) return;
...
void LMotorDrive::turnLeft(int speed, bool kick)
{
...
void LMotorDrive::turnRight(int speed, bool kick)
{
